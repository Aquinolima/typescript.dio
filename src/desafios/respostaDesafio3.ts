export {} // Esse código faz com que não acuse as variáveis duplicadas
/** 
...
botaoLimpar.addEventListener('click', () => { // Aqui o typescript não acusou o botao de ser nulo sem precisar do if. Para testar é só retirar a exclamação.
    limparSaldo();
});

/**
 //BASE PARA COLAR NO INDEX.HTML
